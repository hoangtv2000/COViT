...
class Trainer(BaseTrainer):
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            self.logger.info(f"Training at Pneunomia fold: {p}; Normal fold: {n}")

            self.train_data_loader, train_pneufold, train_normfold = get_balance_train_data(self.config\
                                            , p=p, n=n, reset_state=self.reset_trainloader) # Sequentially data sampling
